...
const mostrarProductosRelacionados = (id, nombre, precio, descripcion, imagen, categoria) => {
      ...
      clientServices.listaProductos().then(data => {
        data.forEach(({id, nombre, precio, descripcion, imagen, categoria}) => {
          ...
          if(categoria === "Star wars" && categoriaSolicitada === "Star wars" && idProductoVisto != id){
            const nuevoProducto = mostrarProductosRelacionados(id, nombre, precio, descripcion, imagen, categoria);
