  ...
  clientServices.listaProductos().then(data => {
    data.forEach(({id, nombre, precio, descripcion, imagen, categoria}) => {
      ...
      if(validar || validarCategoria){
        const mostrarResultadoBuscado = MostrarProductos(id, nombre, precio, descripcion, imagen, categoria);
    ...
    if (evento.key === 'Enter') {
      ...
      clientServices.listaProductos().then(data => {
        data.forEach(({id, nombre, precio, descripcion, imagen, categoria}) => {
          ...
          if(validar){
            const mostrarProductoBuscado = MostrarProductos(id, nombre, precio, descripcion, imagen, categoria);
